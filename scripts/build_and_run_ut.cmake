...
# Build and run unit tests using g++ and GoogleTest (direct binary).
# This script intentionally runs the GoogleTest binary itself and does NOT use CTest.
...
# Run GoogleTest binary directly (no CTest).
if(WIN32)
  set(test_exe "${build_dir}/tests/hello_world_tests.exe")
else()
  set(test_exe "${build_dir}/tests/hello_world_tests")
endif()

if(NOT EXISTS "${test_exe}")
  message(FATAL_ERROR "Test binary not found: ${test_exe}")
endif()

message(STATUS "Running GoogleTest binary directly...")
execute_process(COMMAND "${test_exe}" RESULT_VARIABLE test_result)
