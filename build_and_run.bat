@echo off
REM Build and run script for Windows using g++ (MinGW/MSYS2)
...
REM Build the project (app + unit tests)
...
REM Run the unit test binary directly
echo.
echo 3. Running unit tests:
.\tests\hello_world_tests.exe
if %errorlevel% neq 0 (
